...
var Cone = /** @class */ (function (_super) {
    ...
    function Cone(color, coneRadius, coneHeight, radialSegments, controlsOpacity) {
        if (coneRadius === void 0) { coneRadius = DEFAULT_CONE_RADIUS; }
        if (coneHeight === void 0) { coneHeight = DEFAULT_CONE_HEIGHT; }
        if (radialSegments === void 0) { radialSegments = DEFAULT_RADIAL_SEGMENTS; }
        if (controlsOpacity === void 0) { controlsOpacity = DEFAULT_CONTROLS_OPACITY; }
        var _this = _super.call(this) || this;
        _this.geometry = new ConeGeometry(coneRadius, coneHeight, radialSegments);
...
var Line = /** @class */ (function (_super) {
    ...
    function Line(color, geometry, controlsOpacity) {
        if (controlsOpacity === void 0) { controlsOpacity = DEFAULT_CONTROLS_OPACITY; }
        var _this = _super.call(this) || this;
...
var Translation = /** @class */ (function (_super) {
    ...
    function Translation(color, lineHeight, coneRadius, coneHeight, radialSegments, controlsOpacity) {
        ...
        if (lineHeight === void 0) { lineHeight = DEFAULT_LINE_HEIGHT; }
        if (coneRadius === void 0) { coneRadius = DEFAULT_CONE_RADIUS; }
        if (coneHeight === void 0) { coneHeight = DEFAULT_CONE_HEIGHT; }
        if (radialSegments === void 0) { radialSegments = DEFAULT_RADIAL_SEGMENTS; }
        if (controlsOpacity === void 0) { controlsOpacity = DEFAULT_CONTROLS_OPACITY; }
        ...
        _this.cone = new Cone(color, coneRadius, coneHeight, radialSegments, controlsOpacity);
        var lineGeometry = new Geometry();
        lineGeometry.vertices.push(new Vector3(0, 0, 0));
        lineGeometry.vertices.push(new Vector3(0, lineHeight, 0));
        _this.line = new Line(color, lineGeometry, controlsOpacity);
...
var Octahedron = /** @class */ (function (_super) {
    ...
    function Octahedron(color, octahedronRadius) {
        if (octahedronRadius === void 0) { octahedronRadius = DEFAULT_OCTAHEDRON_RADIUS; }
        var _this = _super.call(this) || this;
        _this.geometry = new OctahedronBufferGeometry(octahedronRadius, 0);
...
var Rotation = /** @class */ (function (_super) {
    ...
    function Rotation(color, ringRadius, octahedronRadius) {
        ...
        _this.handlebar = new Octahedron(color, octahedronRadius);
...
var Pick = /** @class */ (function (_super) {
    ...
    function Pick(octahedronRadius) {
        if (octahedronRadius === void 0) { octahedronRadius = DEFAULT_OCTAHEDRON_RADIUS; }
        var _this = _super.call(this) || this;
        /**
         * @hidden
        ...
        _this.octahedron = new Octahedron("white", octahedronRadius);
...
var Plane = /** @class */ (function (_super) {
    ...
    function Plane(color, width, height, planeSegments) {
        if (color === void 0) { color = DEFAULT_COLOR_RING; }
        if (width === void 0) { width = DEFAULT_PLANE_WIDTH; }
        if (height === void 0) { height = DEFAULT_PLANE_HEIGHT; }
        if (planeSegments === void 0) { planeSegments = DEFAULT_PLANE_SEGMENTS; }
        var _this = _super.call(this) || this;
        _this.geometry = new PlaneGeometry(width, height, planeSegments);
        _this.material = new MeshBasicMaterial({
            color: color,
            depthTest: false,
            side: DoubleSide,
...
var PickPlane = /** @class */ (function (_super) {
    ...
    function PickPlane(color, width, height, planeSegments, controlsOpacity) {
        ...
        crossYGeometry.vertices.push(new Vector3(vertexMaxX, 0, 0));
        _this.boundary = new Line(color, boundaryGeometry, controlsOpacity);
        _this.crossX = new Line("black", crossXGeometry, controlsOpacity);
        _this.crossY = new Line("black", crossYGeometry, controlsOpacity);
        _this.plane = new Plane(color, width, height, planeSegments);
...
var Controls = /** @class */ (function (_super) {
    ...
    function Controls(object, camera, options) {
        ...
        _this.mode = (_b = (_a = _this.options) === null || _a === void 0 ? void 0 : _a.mode) !== null && _b !== void 0 ? _b : ANCHOR_MODE.FIXED;
        ...
        _this.lineHeight = (_3 = (_2 = _this.options) === null || _2 === void 0 ? void 0 : _2.lineHeight) !== null && _3 !== void 0 ? _3 : DEFAULT_LINE_HEIGHT;
        _this.coneRadius = (_5 = (_4 = _this.options) === null || _4 === void 0 ? void 0 : _4.coneRadius) !== null && _5 !== void 0 ? _5 : DEFAULT_CONE_RADIUS;
        _this.coneHeight = (_7 = (_6 = _this.options) === null || _6 === void 0 ? void 0 : _6.coneHeight) !== null && _7 !== void 0 ? _7 : DEFAULT_CONE_HEIGHT;
        _this.radialSegments = (_9 = (_8 = _this.options) === null || _8 === void 0 ? void 0 : _8.radialSegments) !== null && _9 !== void 0 ? _9 : DEFAULT_RADIAL_SEGMENTS;
        _this.controlsOpacity = (_11 = (_10 = _this.options) === null || _10 === void 0 ? void 0 : _10.controlsOpacity) !== null && _11 !== void 0 ? _11 : DEFAULT_CONTROLS_OPACITY;
        _this.planeSegments = (_13 = (_12 = _this.options) === null || _12 === void 0 ? void 0 : _12.planeSegments) !== null && _13 !== void 0 ? _13 : DEFAULT_PLANE_SEGMENTS;
        if (_this.options.orientation !== undefined) {
            var _14 = _this.options.orientation, x = _14.x, y = _14.y, z = _14.z, w = _14.w;
        ...
        _this.pick = new Pick();
        _this.pickPlaneXY = new PickPlane("yellow", _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.planeSegments, _this.controlsOpacity);
        _this.pickPlaneYZ = new PickPlane("cyan", _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.planeSegments, _this.controlsOpacity);
        _this.pickPlaneZX = new PickPlane("pink", _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.planeSegments, _this.controlsOpacity);
        _this.translationXP = new Translation("red", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
        _this.translationYP = new Translation("green", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
        _this.translationZP = new Translation("blue", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
        _this.translationXN = new Translation("red", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
        _this.translationYN = new Translation("green", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
        _this.translationZN = new Translation("blue", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
