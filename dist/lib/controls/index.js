...
var Controls = /** @class */ (function (_super) {
    ...
    function Controls(object, camera, options) {
        ...
        _this.separation = (_r = (_q = _this.options) === null || _q === void 0 ? void 0 : _q.separation) !== null && _r !== void 0 ? _r : constants_1.DEFAULT_CONTROLS_SEPARATION;
        _this.isDampingEnabled = (_t = (_s = _this.options) === null || _s === void 0 ? void 0 : _s.isDampingEnabled) !== null && _t !== void 0 ? _t : true;
        _this.rotationRadiusScale = (_v = (_u = _this.options) === null || _u === void 0 ? void 0 : _u.rotationRadiusScale) !== null && _v !== void 0 ? _v : constants_1.DEFAULT_ROTATION_RADIUS_SCALE;
        _this.eyeRotationRadiusScale = (_x = (_w = _this.options) === null || _w === void 0 ? void 0 : _w.eyeRotationRadiusScale) !== null && _x !== void 0 ? _x : constants_1.DEFAULT_EYE_ROTATION_SCALE;
        _this.pickPlaneSizeScale = (_z = (_y = _this.options) === null || _y === void 0 ? void 0 : _y.pickPlaneSizeScale) !== null && _z !== void 0 ? _z : constants_1.DEFAULT_PLANE_SIZE_SCALE;
        _this.translationDistanceScale = (_1 = (_0 = _this.options) === null || _0 === void 0 ? void 0 : _0.translationDistanceScale) !== null && _1 !== void 0 ? _1 : constants_1.DEFAULT_TRANSLATION_DISTANCE_SCALE;
        _this.lineHeight = (_3 = (_2 = _this.options) === null || _2 === void 0 ? void 0 : _2.lineHeight) !== null && _3 !== void 0 ? _3 : constants_1.DEFAULT_LINE_HEIGHT;
        _this.coneRadius = (_5 = (_4 = _this.options) === null || _4 === void 0 ? void 0 : _4.coneRadius) !== null && _5 !== void 0 ? _5 : constants_1.DEFAULT_CONE_RADIUS;
        _this.coneHeight = (_7 = (_6 = _this.options) === null || _6 === void 0 ? void 0 : _6.coneHeight) !== null && _7 !== void 0 ? _7 : constants_1.DEFAULT_CONE_HEIGHT;
        _this.radialSegments = (_9 = (_8 = _this.options) === null || _8 === void 0 ? void 0 : _8.radialSegments) !== null && _9 !== void 0 ? _9 : constants_1.DEFAULT_RADIAL_SEGMENTS;
        _this.controlsOpacity = (_11 = (_10 = _this.options) === null || _10 === void 0 ? void 0 : _10.controlsOpacity) !== null && _11 !== void 0 ? _11 : constants_1.DEFAULT_CONTROLS_OPACITY;
        _this.planeSegments = (_13 = (_12 = _this.options) === null || _12 === void 0 ? void 0 : _12.planeSegments) !== null && _13 !== void 0 ? _13 : constants_1.DEFAULT_PLANE_SEGMENTS;
        ...
        _this.pickPlaneXY = new pick_plane_1.default("yellow", _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.planeSegments, _this.controlsOpacity);
        _this.pickPlaneYZ = new pick_plane_1.default("cyan", _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.planeSegments, _this.controlsOpacity);
        _this.pickPlaneZX = new pick_plane_1.default("pink", _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.boundingSphereRadius * _this.pickPlaneSizeScale, _this.planeSegments, _this.controlsOpacity);
        _this.translationXP = new translation_1.default("red", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
        _this.translationYP = new translation_1.default("green", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
        _this.translationZP = new translation_1.default("blue", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
        _this.translationXN = new translation_1.default("red", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
        _this.translationYN = new translation_1.default("green", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
        _this.translationZN = new translation_1.default("blue", _this.lineHeight, _this.coneRadius, _this.coneHeight, _this.radialSegments, _this.controlsOpacity);
