...
var PickPlane = /** @class */ (function (_super) {
    ...
    function PickPlane(color, width, height, planeSegments, controlsOpacity) {
        ...
        if (planeSegments === void 0) { planeSegments = constants_1.DEFAULT_PLANE_SEGMENTS; }
        ...
        crossYGeometry.vertices.push(new THREE.Vector3(vertexMaxX, 0, 0));
        _this.boundary = new line_1.default(color, boundaryGeometry, controlsOpacity);
        _this.crossX = new line_1.default("black", crossXGeometry, controlsOpacity);
        _this.crossY = new line_1.default("black", crossYGeometry, controlsOpacity);
        _this.plane = new plane_1.default(color, width, height, planeSegments);
